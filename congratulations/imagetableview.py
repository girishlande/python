...
class ImageTableView(QWidget):
    def __init__(self):
        ...
        for n, fn in enumerate(glob.glob("./images/*.png")):
            image = QImage(fn)
    ...
    def selChanged(self,selected,deselected):
        ...
        for index in selected.indexes():
            ...
            i = index.row() * NUMBER_OF_COLUMNS + index.column()
            self.selecteditem = self.model.previews[i]
            #print("Selected:",self.selecteditem.title)